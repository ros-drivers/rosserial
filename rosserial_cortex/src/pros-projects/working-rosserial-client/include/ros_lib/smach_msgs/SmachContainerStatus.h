  ...
  class SmachContainerStatus : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->initial_states_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_initial_statesi = vexstrlen(this->initial_states[i]);
      ...
      *(outbuffer + offset + 3) = (this->active_states_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_active_statesi = vexstrlen(this->active_states[i]);
      ...
      uint32_t length_local_data = vexstrlen(this->local_data);
      ...
      uint32_t length_info = vexstrlen(this->info);
