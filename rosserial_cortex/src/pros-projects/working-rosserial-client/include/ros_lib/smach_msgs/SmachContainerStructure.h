...
namespace smach_msgs
{
  ...
  class SmachContainerStructure : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t length_path = vexstrlen(this->path);
      ...
      *(outbuffer + offset + 3) = (this->children_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_childreni = vexstrlen(this->children[i]);
      ...
      *(outbuffer + offset + 3) = (this->internal_outcomes_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_internal_outcomesi = vexstrlen(this->internal_outcomes[i]);
      ...
      *(outbuffer + offset + 3) = (this->outcomes_from_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_outcomes_fromi = vexstrlen(this->outcomes_from[i]);
      ...
      *(outbuffer + offset + 3) = (this->outcomes_to_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_outcomes_toi = vexstrlen(this->outcomes_to[i]);
      ...
      *(outbuffer + offset + 3) = (this->container_outcomes_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_container_outcomesi = vexstrlen(this->container_outcomes[i]);
