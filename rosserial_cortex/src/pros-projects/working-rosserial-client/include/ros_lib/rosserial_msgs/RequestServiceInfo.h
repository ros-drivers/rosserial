...
static const char REQUESTSERVICEINFO[] = "rosserial_msgs/RequestServiceInfo";
  ...
  class RequestServiceInfoRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_service = vexstrlen(this->service);
  ...
  class RequestServiceInfoResponse : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_service_md5 = vexstrlen(this->service_md5);
      ...
      uint32_t length_request_md5 = vexstrlen(this->request_md5);
      ...
      uint32_t length_response_md5 = vexstrlen(this->response_md5);
