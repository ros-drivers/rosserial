...
static const char GETMODELPROPERTIES[] = "gazebo_msgs/GetModelProperties";
  ...
  class GetModelPropertiesRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_model_name = vexstrlen(this->model_name);
  ...
  class GetModelPropertiesResponse : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_parent_model_name = vexstrlen(this->parent_model_name);
      ...
      uint32_t length_canonical_body_name = vexstrlen(this->canonical_body_name);
      ...
      *(outbuffer + offset + 3) = (this->body_names_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_body_namesi = vexstrlen(this->body_names[i]);
      ...
      *(outbuffer + offset + 3) = (this->geom_names_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_geom_namesi = vexstrlen(this->geom_names[i]);
      ...
      *(outbuffer + offset + 3) = (this->child_model_names_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_child_model_namesi = vexstrlen(this->child_model_names[i]);
