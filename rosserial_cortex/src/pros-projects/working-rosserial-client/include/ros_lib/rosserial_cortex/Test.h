...
namespace rosserial_cortex
{

static const char TEST[] = "rosserial_cortex/Test";
  ...
  class TestRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_input = vexstrlen(this->input);
  ...
  class TestResponse : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_output = vexstrlen(this->output);
